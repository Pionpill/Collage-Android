...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,OnSnakeDeadListener,OnSnakeEatFoodListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bgmMusicPlayer = MediaPlayer.create(this, R.raw.bgm);
    ...
    public void OnSnakeDead(int foodcnt) {
        MediaPlayer deadMusicPlayer = MediaPlayer.create(this, R.raw.die);
        deadMusicPlayer.start();
    ...
    public void OnSnakeEatFood(int foodcnt) {
        MediaPlayer eatMusicPlayer = MediaPlayer.create(this, R.raw.eat);
        eatMusicPlayer.start();
