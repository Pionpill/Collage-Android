...
public class SnakeView extends View {
    ...
    private int mBlocksize = 40;//单元格的边长
    ...
    public void InitGame(){
        ptBackground.setColor(Color.argb(255,240,240,210));
        ptHead.setColor(Color.argb(255,42,150,210));
        ptBody.setColor(Color.argb(255,105,200,110));
        ptBorder.setColor(Color.argb(255,33,33,44));
        ptFood.setColor(Color.argb(255,250,90,90));
        InitSnake();
